        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-form method="PUT" action="{{ route('admin.newsletter.update', $item->id) }}" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                <x-form_input label="Email" placeholder="Enter email address" name="email" value="{{ $item->email }}"
